...
public class MultiChoiceHelper {
    ...
    private static final String TAG = MultiChoiceHelper.class.getSimpleName();
    ...
    public static abstract class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void updateCheckedState(int position) {
            ...
            Log.d(TAG,"updateCheckedState has been called for " + position + " " + isChecked);
            if (itemView instanceof Checkable) {
                ((Checkable) itemView).setChecked(isChecked);
            } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                Log.d(TAG,"setting tag is activated");
        ...
        public void bind(MultiChoiceHelper multiChoiceHelper, int position) {
            Log.d(TAG,"bind of viewholder has been called");
